...
class AuthorRecommendServiceTest:FunSpec ({
    ...
    lateinit var authroRecommendService: AuthorRecommendService

    beforeTest {
        authorRepository = mockk()
        authroRecommendService = AuthorRecommendService(authorRepository)
    }
    ...
    context("AuthorRecommendServiceTest"){
        test("getRecommendAuthors") {
            ...
            // when
            val recommendAuthors = authroRecommendService.getRecommendAuthors()
